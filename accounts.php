...
try {
	...
	if ($member === 'professor') {
		$users = $db->select('users', '*', ['role' => 'professor']);
	} else {
							...
							<div id="kt_app_toolbar_container" class="app-container container-xxl d-flex flex-stack">
								...
								<div class="page-title d-flex flex-column justify-content-center flex-wrap me-3">
									...
									<h1
										...
										$member_capitalized = ucfirst($member);

										// Echo the result
										echo $member_capitalized;
										?>
										List
									</h1>
									<!--end::Title-->
									...
									<div class="card-body py-4">
										...
										<table class="table align-middle table-row-dashed fs-6 gy-5"
											...
											<thead>
												<tr class="text-start text-muted fw-bold fs-7 text-uppercase gs-0">
													...
													<?php else: ?>
															...
															<th class="min-w-125px">Student Number</th>
											...
											<tbody class="text-gray-600 fw-semibold">
														...
														<?php foreach ($users as $user): ?>
																<tr>
																	<?php if ($member === 'professor'): ?>
																			...
																			<td><?php echo htmlspecialchars($user['middle_name'] ?? 'N/A'); ?>
																			</td>
												...
												<?php else: ?>
														<tr>
															<td colspan="<?php echo $member === 'professor' ? '6' : '10'; ?>"
