...
try {
  ...
  $staffmembers = $db->select('users', '*');
  $studentmembers = $db->select('students', '*');
  $combinedMembers = array_merge($staffmembers, $studentmembers);
  ...
  foreach ($combinedMembers as $member) {
    if (isset($member['role'])) {
      $rolesCounter[$member['role']]++;
    } else {
      $rolesCounter['student']++;
    }
  }
  $total_members = array_sum($rolesCounter);

  $users = $db->select('students', '*');
  $counters = [];

  foreach ($users as $user) {
    $clean_section = str_replace($user['department'], '', $user['section']);
    $key = $user['department'] . ':' . $clean_section;
    ...
    $counters[$key]['students']++;
  }


  $result = array_values($counters);
  $total_sections = count($counters);
...
<div id="admin-count" style="display:none;"><?php echo $rolesCounter['admin']; ?></div>
<div id="professor-count" style="display:none;"><?php echo $rolesCounter['professor']; ?></div>
<div id="student-count" style="display:none;"><?php echo $rolesCounter['student']; ?></div>
              ...
              <div id="kt_app_toolbar_container" class="app-container container-xxl d-flex flex-stack">
                ...
                <div class="page-title d-flex flex-column justify-content-center flex-wrap me-3">
                  ...
                  <h1 class="page-heading d-flex text-gray-900 fw-bold fs-3 flex-column justify-content-center my-0">
                    Hello <?php echo ucfirst($_SESSION['name']); ?>
                ...
                <div class="d-flex align-items-center py-2 py-md-1">
                  ...
                  <div class="me-3">
                    <!--begin::Menu-->
                    <a href="download.php?download=true" class="btn btn-light fw-bold">
                        ...
                        <div class="mb-10">
                          ...
                          <div>
                            <select class="form-select form-select-solid select2-hidden-accessible" multiple=""
                              ...
                              data-dropdown-parent="#kt_menu_675b13cbeb793" data-allow-clear="true"
                              data-select2-id="select2-data-7-759g" tabindex="-1" aria-hidden="true"
                              ...
                              data-select2-id="select2-data-8-d5b7" style="width: 100%;"><span class="selection"><span
                                  ...
                                  aria-disabled="false">
                                  <ul class="select2-selection__rendered" id="select2-oly5-container"></ul><span
                                    class="select2-search select2-search--inline"><textarea
                                      class="select2-search__field" type="search" tabindex="0" autocorrect="off"
                                      autocapitalize="none" spellcheck="false" role="searchbox" aria-autocomplete="list"
                                      autocomplete="off" aria-label="Search" aria-describedby="select2-oly5-container"
                              ...
                              <div class="me-md-5 w-100">
                                ...
                                <div class="d-flex border border-gray-300 border-dashed rounded p-6 mb-6">
                                  ...
                                  <div class="d-flex align-items-center flex-grow-1 me-2 me-sm-5">
                                    ...
                                    <div class="me-2">
                                      ...
                                      <span class="text-gray-500 fw-bold d-block fs-7">Overall attendance regardless of
                                        section</span>
                                    </div>
                                    <!--end::Section-->
                                  </div>
                                  ...
                                  <div class="d-flex align-items-center">
                                    <span
                                      class="text-gray-900 fw-bolder fs-2x"><?php echo $dashboard_stats['total_attendance']; ?></span>
                                  </div>
                                  <!--end::Info-->
                                </div>
                                <!--end::Item-->
                                ...
                                <div class="d-flex border border-gray-300 border-dashed rounded p-6 mb-6">
                                  ...
                                  <div class="d-flex align-items-center flex-grow-1 me-2 me-sm-5">
                                    ...
                                    <!--begin::Section-->
                                    <div class="me-2">
                                      <a href="#" class="text-gray-800 text-hover-primary fs-6 fw-bold">Members</a>
                                      <span class="text-gray-500 fw-bold d-block fs-7">Overall members regardless of
                                        role</span>
                                    </div>
                                    <!--end::Section-->
                                  </div>
                                  ...
                                  <div class="d-flex align-items-center">
                                    <span
                                      class="text-gray-900 fw-bolder fs-2x"><?php echo $dashboard_stats['total_members']; ?></span>
                                  </div>
                                  <!--end::Info-->
                                </div>
                                <!--end::Item-->
                                ...
                                <div class="d-flex border border-gray-300 border-dashed rounded p-6 mb-6">
                                  ...
                                  <div class="d-flex align-items-center flex-grow-1 me-2 me-sm-5">
                                    ...
                                    <!--begin::Section-->
                                    <div class="me-2">
                                      <a href="#" class="text-gray-800 text-hover-primary fs-6 fw-bold">Sections</a>
                                      <span class="text-gray-500 fw-bold d-block fs-7">Overall sections regardless of
                                        department</span>
                                    </div>
                                    <!--end::Section-->
                                  </div>
                                  ...
                                  <div class="d-flex align-items-center">
                                    <span
                                      class="text-gray-900 fw-bolder fs-2x"><?php echo $dashboard_stats['total_sections']; ?></span>
                                  </div>
                                  <!--end::Info-->
                                </div>
                                <!--end::Item-->
                    ...
                    <div class="card h-xl-100">
                      ...
                      <div class="card-header border-0 pt-5">
                        <h3 class="card-title align-items-start flex-column">
                          <span class="card-label fw-bold text-gray-900">Courses & Section</span>
                      ...
                      <div class="card-body pt-6">
                        ...
                        foreach ($result as $item) {
                          $title = "{$item['department']} - {$item['section']}";
                          $subtitle = "{$item['students']} Student" . ($item['students'] > 1 ? "s" : "");
                          $symbol = strtoupper($item['section'][0]); // Take the first character of the section as the symbol
                          $color = $symbol === '4' ? 'bg-danger text-inverse-danger' : 'bg-success text-inverse-success'; // Example for alternating color
                          $link = "accounts.php?member=student&search=" . urlencode($item['department'] . $item['section']);
                          echo <<<HTML
<!--begin::Item-->
<div class="d-flex flex-stack">
    <!--begin::Symbol-->
    <div class="symbol symbol-40px me-4">
        <div class="symbol-label fs-2 fw-semibold {$color}">
            {$symbol}
        </div>
    </div>
    <!--end::Symbol-->
    ...
    <div class="d-flex align-items-center flex-row-fluid flex-wrap">
        ...
        <div class="flex-grow-1 me-2">
            <a href="#" class="text-gray-800 text-hover-primary fs-6 fw-bold">{$title}</a>
            <span class="text-muted fw-semibold d-block fs-7">{$subtitle}</span>
        </div>
        <!--end:Author-->
        <!--begin::Actions-->
        <a href="{$link}" class="btn btn-sm btn-icon btn-bg-light btn-active-color-primary w-30px h-30px">
          ...
          <div class="timeline timeline-border-dashed">
                ...
                <div class="overflow-auto pb-5">
                  ...
                  <div
                    ...
                    <a href="apps/projects/project.html"
                      class="fs-5 text-gray-900 text-hover-primary fw-semibold w-375px min-w-200px">Meeting with
                      customer</a>
                    <!--end::Title-->
                    <!--begin::Label-->
                  ...
                  <div
                    ...
                    <!--begin::Title-->
                    <a href="apps/projects/project.html"
                      class="fs-5 text-gray-900 text-hover-primary fw-semibold w-375px min-w-200px">Project Delivery
                      Preparation</a>
                    <!--end::Title-->
                    <!--begin::Label-->
            ...
            <div class="timeline-item">
              ...
              <div class="timeline-content mb-10 mt-n1">
                ...
                <div class="mb-5 pe-3">
                  <!--begin::Title-->
                  <a href="#" class="fs-5 fw-semibold text-gray-800 text-hover-primary mb-2">3 New Incoming Project
                    Files:</a>
                  <!--end::Title-->
                  <!--begin::Description-->
                  <div class="d-flex align-items-center mt-1 fs-6">
      ...
      <div class="card-body hover-scroll-overlay-y h-400px pt-5">
        ...
        <div class="d-flex flex-stack">
          ...
          <div class="d-flex flex-column me-3">
            <!--begin::Section-->
            <div class="mb-3">
              <a href="apps/ecommerce/sales/details.html" class="text-gray-800 text-hover-primary fs-4 fw-bold">$D
                Printer</a>
                ...
                <div class="w-100">
                  ...
                  <div class="pb-8 pb-lg-10">
                    ...
                    <div class="text-muted fw-semibold fs-6">
                      ...
                      <a href="authentication/layouts/corporate/sign-in.html" class="link-primary fw-bold">Sign In</a>.
                    </div>
                    <!--end::Notice-->
                  </div>
                  <!--end::Heading-->
                      ...
                      <div class="mh-300px scroll-y me-n7 pe-7">
                        ...
                        <div
                          ...
                          <div class="d-flex align-items-center">
                            ...
                            <!--begin::Details-->
                            <div class="ms-6">
                              <a href="#" class="fs-5 fw-bold text-gray-900 text-hover-primary mb-2">Avionica Technical
                                Requirements</a>
