...
if ($_SESSION['role'] === 'professor') {
  try {
    $db = new PDO('sqlite:DATABASE/fram_attendance.db');
    ...
    <div class="app-page flex-column flex-column-fluid" id="kt_app_page">
      ...
      <div class="app-wrapper flex-column flex-row-fluid" id="kt_app_wrapper">
            ...
            <div id="kt_app_toolbar" class="app-toolbar py-3 py-lg-6">
              ...
              <div id="kt_app_toolbar_container" class="app-container container-xxl d-flex flex-stack">
                ...
                <div class="d-flex align-items-center py-2 py-md-1">
                  ...
                  <div class="me-3">
                    <!--begin::Menu-->
                    <a href="download2.php?download=true" class="btn btn-light fw-bold">
                    ...
                    <div class="card-title">
                      ...
                      <div class="d-flex align-items-center position-relative my-1">
                        ...
                        <input type="text" data-kt-user-table-filter="search"
                          class="form-control form-control-solid w-250px ps-13" placeholder="Search Attendance" />
                      </div>
                      <!--end::Search-->
                    </div>
                    <!--begin::Card title-->
          ...
          <tbody class="text-gray-600 fw-semibold">
            ';
                ...
                <tr>
                  ...
                  <td>' . htmlspecialchars($row['time_out'] ?? 'N/A') . '</td>
                </tr>';
                      }
                      echo '
          </tbody>
        ...
        ';
                      ...
                      // Display the existing table for other roles (if any attendance data is available)
                      echo '
    <!--begin::Table-->
    <table class="table align-middle table-row-dashed fs-6 gy-5" id="kt_table_users">
      <thead>
