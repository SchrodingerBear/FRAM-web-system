...
var KTChartsWidget22 = (function () {
  ...
  return {
    init: function () {
      // Dynamically retrieve the PHP values from the HTML elements
      var adminCount = parseInt(
        document.getElementById('admin-count').innerText
      )
      var professorCount = parseInt(
        document.getElementById('professor-count').innerText
      )
      var studentCount = parseInt(
        document.getElementById('student-count').innerText
      )

      // Use the dynamically retrieved values in the chart
      e(
        '#kt_chart_widgets_22_tab_1',
        '#kt_chart_widgets_22_chart_1',
        [adminCount, professorCount, studentCount], // Use dynamic PHP values here
        !0
      ),
        e(
